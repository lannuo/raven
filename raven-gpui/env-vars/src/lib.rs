...
/// Whether Raven is running in stateless mode.
/// When true, Raven will use in-memory databases instead of persistent storage.
pub static RAVEN_STATELESS: LazyLock<bool> = bool_env_var!("RAVEN_STATELESS");
